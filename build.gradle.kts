...
intellijPlatform {
    ...
    publishing {
        ...
        // Channel is derived from the version suffix:
        //   0.5.1        -> "default" (Stable)
        //   0.5.1-beta   -> "beta"   (users subscribe via the beta repository URL)
        channels = listOf(version.toString().substringAfter('-', "").ifEmpty { "default" })
    }
}
